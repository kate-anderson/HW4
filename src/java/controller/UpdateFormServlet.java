...
public class UpdateFormServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ReadRecord rr = new ReadRecord(familyID);
        
        //use ReadRecord to get the family data
        rr.doRead();
        Family fam =rr.getFamily();
        
        //pass family and control to updateForm.jsp
        request.setAttribute("family", fam);
